...
reward = 0.0  # pour éviter une variable non définie si arrêt très tôt (rare)
...
while not done:
    ...
    # Convertir en int pour les comparaisons (SB3 renvoie souvent un numpy scalar/array)
